...
namespace Photon.Pun.MFPS
{
    ...
    /// Scoring system for PhotonPlayer
    /// </summary>
    public class MyPunPlayerScores : MonoBehaviour
    {
    ...
    public static class ScoreExtensions
    {
        public static void SetScore(this Player player, int newScore)
        {
            ...
            score[MyPunPlayerScores.PlayerScoreProp] = newScore;
        ...
        public static void AddScore(this Player player, int scoreToAddToCurrent)
        {
            ...
            Hashtable score = new Hashtable();  // using PUN's implementation of Hashtable
            score[MyPunPlayerScores.PlayerScoreProp] = current;
        ...
        {
            object score;
            if (player.CustomProperties.TryGetValue(MyPunPlayerScores.PlayerScoreProp, out score))
            {
                return (int)score;
            }
