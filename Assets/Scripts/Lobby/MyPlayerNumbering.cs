...
namespace MFPS
{
    ...
    /// </remarks>
    public class MyPlayerNumbering : MonoBehaviourPunCallbacks
    {
        ...
        /// </summary>
        public static MyPlayerNumbering instance;
        ...
        public const string RoomPlayerIndexedProp = "pNumber";
        public const string RoomPlayerRacerProp = "pRacer";
        ...
        {
            PhotonNetwork.LocalPlayer.CustomProperties.Remove(MyPlayerNumbering.RoomPlayerIndexedProp);
        }
        ...
        {
            if (changedProps != null )//&& changedProps.ContainsKey(MyPlayerNumbering.RoomPlayerIndexedProp)
            {
                this.RefreshData();
            }
        }
    ...
    public static class PlayerNumberingExtensions
    {
        ...
        public static int GetPlayerNumber(this Player player)
        {
            ...
            object value;
			if (player.CustomProperties.TryGetValue (MyPlayerNumbering.RoomPlayerIndexedProp, out value)) {
				return (byte)value;
			}
            return -1;
        }
        ...
        public static void SetPlayerNumber(this Player player, int playerNumber)
        {
            ...
            if (current != playerNumber)
            {
                ...
                player.SetCustomProperties(new Hashtable() { { MyPlayerNumbering.RoomPlayerIndexedProp, (byte)playerNumber } });
            }
        }
    }
}