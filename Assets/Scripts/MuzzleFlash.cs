...
public class MuzzleFlash : MonoBehaviour
{
    ...
    [Tooltip("The minimum fade speed - the larger the value the quicker the muzzle flash will fade.")] [SerializeField]
    protected float m_MinFadeSpeed = 3;

    [Tooltip("The maximum fade speed - the larger the value the quicker the muzzle flash will fade.")] [SerializeField]
