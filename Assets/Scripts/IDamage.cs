...
public class DamageData
{
    ...
    [Tooltip("The hit position.")] protected Vector3 m_Position;
    [Tooltip("The hit direction.")] protected Vector3 m_Direction;
    ...
    [Tooltip("The radius of the force.")] protected float m_Radius;
    ...
    public IDamageOriginator DamageOriginator
    {
        get => m_DamageOriginator;
        set => m_DamageOriginator = value;
    }

    public IDamageTarget DamageTarget
    {
        get => m_DamageTarget;
        set => m_DamageTarget = value;
    }
    ...
    /// </summary>
    public virtual void SetDamage(float amount, Vector3 position, Vector3 direction, float forceMagnitude, int frames,
        float radius, GameObject attacker, object attackerObject, Collider hitCollider)
    {
        ...
        {
            Owner = attacker,
            OriginatingGameObject = (attackerObject is MonoBehaviour)
                ? (attackerObject as MonoBehaviour).gameObject
                : (attackerObject is GameObject ? (attackerObject as GameObject) : null)
        };
        m_Amount = amount;
        m_Position = position;
    ...
    /// Initializes the DamageData to the spciefied parameters.
    /// </summary>
    public virtual void SetDamage(IDamageOriginator damageOriginator, float amount, Vector3 position, Vector3 direction,
        float forceMagnitude, int frames, float radius, Collider hitCollider)
    {
