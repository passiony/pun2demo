...
namespace MFPS
{
    ...
    public class DamageData
    {
        ...
        /// </summary>
        public virtual void SetDamage(float amount, Vector3 position, Vector3 direction, float forceMagnitude,
            int frames,
        ...
        /// Initializes the DamageData to the spciefied parameters.
        /// </summary>
        public virtual void SetDamage(IDamageOriginator damageOriginator, float amount, Vector3 position,
            Vector3 direction,
