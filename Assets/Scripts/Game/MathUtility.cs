...
public class MathUtility
{
    ...
    public static void CapsuleColliderEndCaps(CapsuleCollider capsuleCollider, Vector3 position, Quaternion rotation,
        out Vector3 firstEndCap, out Vector3 secondEndCap)
    {
    ...
    private static Vector3 ClosestPointOnCapsule(Transform transform, CapsuleCollider capsuleCollider, Vector3 point,
        Vector3 moveDirection, bool sphereCheck, bool lowerPoint)
    {
        ...
        if (segment >= 0 && segment <= 1 &&
            (!lowerPoint || capsuleCollider.transform.InverseTransformPoint(point).y < 0))
        {
            // On cylinder.
    ...
    private static Vector3 ClosestPointOnSphere(Transform transform, Vector3 point, Vector3 sphereCenter, float radius,
        bool sphereCheck, bool lowerPoint)
    {
