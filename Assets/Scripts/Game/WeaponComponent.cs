...
namespace MFPS
{
    ...
    {
        [SerializeField] private EGunType m_WeaponId;
        ...
        private Dictionary<EGunType, GunWeapon> m_WeaponDic;
        ...
        private void Awake()
        {
            ...
            m_WeaponDic = new Dictionary<EGunType, GunWeapon>();
            foreach (var weapon in m_AllWeapons)
            {
                weapon.gameObject.SetActive(false);
                m_WeaponDic.Add(weapon.Type, weapon);
            }
        }
        ...
        public void LoadWeapon(EGunType gunId)
        {
